...
public class Bishop extends Piece {
    ...
    Bishop(Game game, String type, int colour){
        this.game=game;
        this.type=type;
        this.colour=colour;
    }
    ...
    protected boolean validMove(String source, String target){
        ...
        if(endRow-startRow==endCol-startCol){
            ...
            for(char c1=++startRow,c2=++startCol;c1<endRow && c2<endCol;c1++,c2++){
                String temp= Character.toString(c2)+Character.toString(c1);
